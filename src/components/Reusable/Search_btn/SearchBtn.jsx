    ...
    return (
        <div>
            <form className='border rounded-full border-primary_color md:p-2 p-2 md:w-4/5 w-full flex items-center md:my-8 my-2 shadow-lg' onSubmit={handleSubmit}>
                    <select value={searchType} onChange={handleSearchTypeChange} className='md:px-6 px-2 py-2 rounded-l-full border-primary_color bg-white text-primary_color focus:outline-none mb-2 md:mb-0 md:text-base text-sm' required>
