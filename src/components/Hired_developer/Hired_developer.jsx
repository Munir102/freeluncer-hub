...
const NextArrow = ({ onClick }) => {
    return (
        <div
            className="absolute top-[-50px] right-6 text-2xl p-2 border rounded-full text-neutral-100 bg-primary_color cursor-pointer z-10 text-gray-700 hover:text-gray-900 shadow-lg transform hover:shadow-md transition duration-300"
            onClick={onClick}
        >
            <FaArrowRight />
        </div>
...
const PrevArrow = ({ onClick }) => {
    return (
        <div
            className="absolute top-[-50px] right-24 text-2xl p-2 border rounded-full text-neutral-100 bg-primary_color cursor-pointer z-10 text-gray-700 hover:text-gray-900 shadow-lg transform hover:shadow-md transition duration-300"
            onClick={onClick}
        >
            <FaArrowLeft />
        </div>
...
const HiredDeveloper = () => {
    const devData = [
        { name: "John Doe", designation: "Senior Developer", location: "New York, USA", rating: 4.8, workingType: ["Remote", "Full-time"], active: true, image: "https://i.ibb.co/Hn9G4q5/Md-Monirozzaman.jpg" },
        ...
        { name: "Emily Davis", designation: "Full Stack Developer", location: "London, UK", rating: 4.9, workingType: ["Onsite", "Full-time"], active: false, image: "https://via.placeholder.com/300" },
        ...
        { name: "Liam Harris", designation: "Data Scientist", location: "Paris, France", rating: 4.8, workingType: ["Remote", "Full-time"], active: true, image: "https://via.placeholder.com/300" },
        { name: "Olivia Clark", designation: "Machine Learning Engineer", location: "Zurich, Switzerland", rating: 4.9, workingType: ["Onsite", "Full-time"], active: false, image: "https://via.placeholder.com/300" },
        ...
        { name: "Mia King", designation: "Security Engineer", location: "Tokyo, Japan", rating: 4.8, workingType: ["Remote", "Contract"], active: false, image: "https://via.placeholder.com/300" },
        ...
        { name: "Lucas Robinson", designation: "AI Developer", location: "Stockholm, Sweden", rating: 4.9, workingType: ["Remote", "Full-time"], active: true, image: "https://via.placeholder.com/300" },
    ...
    return (
        <div className="font-poppins md:mt-24 mt-4 md:p-2 p-4 flex flex-col gap-8">
            ...
            <Slider {...settings} className="gap-4">
                <div key="highest-rated" className="p-2">
                    <DeveloperCard
